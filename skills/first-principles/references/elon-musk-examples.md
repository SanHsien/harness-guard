...
> This file keeps only the parts the first-principles framework needs; it is not a full case study of either company.

Classic examples of first principles thinking from SpaceX and Tesla that illustrate the methodology.

## Contents

- [SpaceX: Rocket Cost Reduction](#spacex-rocket-cost-reduction)
- [Tesla: Battery Cost](#tesla-battery-cost)
- [Key Lessons for Software Engineers](#key-lessons-for-software-engineers)
- [The Musk Method Summarized](#the-musk-method-summarized)
- [Caution: When This Approach Fails](#caution-when-this-approach-fails)
...
| Factor | Status Quo | First Principles Opportunity |
|--------|-------------|------------------------------|
...
**Result:** Tesla drove battery cost to the ~$100/kWh range, making EVs cost-competitive with ICE vehicles.
