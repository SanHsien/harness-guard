...
- [Example 1: Database Selection](#example-1-database-selection)
- [Example 2: Microservices vs Monolith](#example-2-microservices-vs-monolith)
- [Example 3: Authentication System](#example-3-authentication-system)
- [Example 4: Caching Strategy](#example-4-caching-strategy)
- [Example 5: API Design](#example-5-api-design)
- [Anti-Pattern: Over-Engineering from First Principles](#anti-pattern-over-engineering-from-first-principles)
- [Template for Your Analysis](#template-for-your-analysis)
...
Full worked example (with cost table and revisit triggers): see ../examples/architecture-review.md
